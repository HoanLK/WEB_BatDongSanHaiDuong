backend.controller("listTinBDSController", ['$scope', '$http', '$window', '$cookies', 'Services', function ($scope, $http, $window, $cookies, Services) {
    ...
    $scope.gridProjects = {
        ...
        onRowClick: function (e) {
            ...
            if (component.clickCount === 1) {
                ...
                var now = new Date();
                var timeClicks = now - component.lastClickTime;
